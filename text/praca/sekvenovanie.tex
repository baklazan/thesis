...
signál. Viditeľným výstupom modelu sú udalosti. Z každého stavu (\kmer{u}) sú možné prechody do štyroch 
\kmer{ov}, ktoré po ňom môžu nasledovať. Napríklad pre $k=6$ sa zo stavu \texttt{ACCGCT} dá prejsť do
...
hodnoty signálu pre jednotlivé \kmer{y} poskytuje výrobca MinIONa \cite{KmerModels}. Na základe tohto
